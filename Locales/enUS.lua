...
--[[Char Tab]]
  ...
  --[[Other]]
    ...
    ["ma_LevelDown"] = "Set Level ( Duplicate )",
    ["ma_Money"] = "Set Money",
    ["ma_Energy"] = "Set Energy",
    ["ma_Rage"] = "Set Rage",
    ["ma_Mana"] = "Set Mana",
    ["ma_Healthpoints"] = "Set Health",
    ["ma_Talents"] = "Talents",
    ["ma_Stats"] = "Stats",
    ["ma_Spells"] = "Spells",
    ["ma_Honor"] = "Set Honor Points",
	 ["ma_RHonor"] = "Honor",
    ["ma_Level"] = "Level",
    ...
    ["ma_Arena"] = "Set Arena Points",
    ["ma_BackWalk"] = "BackWalk ( Not Working )",
    ["ma_Drunk"] = "Set Drunk State",
    ["ma_FlySpeed"] = "FlySpeed",
    ["ma_Gender"] = "Set Gender",
    ["ma_MountSpeed"] = "MountSpeed",
    ["ma_Phase"] = "Set Phase",
    ["ma_RunicPower"] = "Set RunicPower",
    ["ma_Speed"] = "Set Speed",
    ["ma_StandSate"] = "Set StandState",
    ["ma_SwimSpeed"] = "SwimSpeed",
    ["ma_TalentPoints"] = "Set TalentPoints",
